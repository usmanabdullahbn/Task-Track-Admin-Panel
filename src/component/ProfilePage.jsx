...
const ProfilePage = () => {
    ...
    const handleSaveProfile = async () => {
        try {
            ...
            // Fetch updated user details from API
            const updatedUserData = await apiClient.getUserById(user._id);
            const freshUserData = updatedUserData.user || updatedUserData;

            // Update local state with fresh user data from API
    ...
    const handleChangePassword = async () => {
        try {
            ...
            await apiClient.changeUserPassword(user._id, {
        ...
        <div className="flex flex-col md:flex-row h-screen bg-gradient-to-br from-gray-50 to-gray-100">
            ...
            <main className="flex-1 overflow-y-auto pt-16 md:pt-0">
                <div className="p-4 sm:p-6 md:p-8 max-w-1xl mx-auto">
                    {/* Header Section */}
                    <div className="mb-8">
                        <div className="flex items-lef gap-4 mb-4">
                        ...
                        <div className="flex items-center justify-between mb-8">
                            ...
                            {!isEditing ? (
                                <button
                                    ...
                                    className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all shadow-md hover:shadow-lg font-medium"
                                >
                                    <FaEdit size={16} />
                                    Edit Profile
                                </button>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3 rounded-lg border-2 transition-all font-medium ${isEditing
                                        ? "bg-white border-green-300 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
